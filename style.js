(function (blink) {
	...
	var lesblogueursStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	lesblogueursStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_lesblogueurs',
		ckEditorStyles: {
			name: 'lesblogueurs',
			styles: [
		...
		formatCarouselindicators: function (scope, classNavbar) {
			var that = scope || this,
				navbar = ((typeof classNavbar !== "undefined" && classNavbar)?classNavbar:'lesblogueurs-navbar'),
	...
	lesblogueursStyle.prototype = _.extend({}, new blink.theme.styles.basic(), lesblogueursStyle.prototype);

	blink.theme.styles['lesblogueurs'] = lesblogueursStyle;
